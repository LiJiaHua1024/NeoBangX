...
function Gt(e, t, r, i = e.length / L, a = null, o = null, s = null) {
	...
	for (let r = b; r < S; r++) {
		...
		for (let s = y; s < x; s++) {
			...
			if (l) {
				if (P = B(Math.max(0, f?.[ee] ?? 0) * c), u) N = Math.max(M, Math.min(1, P));
				else if (g) N = P;
				else {
...
function un() {
	let e = ln(on), t = ln(sn), n = /* @__PURE__ */ new Uint8Array(65536), r = 0;
...
function xn() {
	let e = yn(_n), t = /* @__PURE__ */ new Uint8Array(1048576), n = 0, r = 0, i = 0, a = 0;
...
function An() {
	...
	let t = /* @__PURE__ */ new Uint8Array(32768);
	for (let n = 0; n < 128; n++) {
		let r = e[256 + n];
		for (let i = 0; i < 256; i++) {
...
function Kn(e, t) {
	let n = 262144, r = new Uint8Array(n * 4);
	for (let i = 0; i < n; i++) {
		let n = i * Pn, a = i * 4;
...
var Cr = class {
	...
	_ensureBloomSourceTarget() {
		return this.bloomSourceTarget?.width === this.sourceWidth && this.bloomSourceTarget?.height === this.sourceHeight || (U(this.gl, this.bloomSourceTarget), this.bloomSourceTarget = this._createTarget(this.sourceWidth, this.sourceHeight), this.bloomSourceTarget !== null);
	}
	_allocateTargets() {
...
var Zr = Xr(Fr, [
	...
	setPreferHdr(e) {
		let t = e !== !1;
		return this.preferHdr !== t && (this.preferHdr = t, !0);
	}
	...
	_ensureBloomSourceTarget() {
		return this.bloomSourceTarget?.width === this.sourceWidth && this.bloomSourceTarget?.height === this.sourceHeight || (qr(this.bloomSourceTarget), this.bloomSourceTarget = Jr(this.device, this.sourceWidth, this.sourceHeight, "BA Click FX WebGPU scaled bloom source"), !0);
	}
	renderScene(e = {}) {
...
function mi(e, t, n) {
	let r = pi(e, e.VERTEX_SHADER, t), i = pi(e, e.FRAGMENT_SHADER, n), a = e.createProgram();
...
var gi = class {
	...
	_initialize() {
		if (!this.destroyed) try {
			...
			let t = e.getParameter(e.MAX_VIEWPORT_DIMS);
			if (this.maximumViewportWidth = t?.[0] ?? this.maximumTextureSize, this.maximumViewportHeight = t?.[1] ?? this.maximumTextureSize, this.finalProgram = mi(e, si, ui), this.coverageProgram = mi(e, ci, li), this.fullscreenVao = e.createVertexArray(), this.coverageVao = e.createVertexArray(), this.coverageBuffer = e.createBuffer(), this.circleTexture = e.createTexture(), !this.fullscreenVao || !this.coverageVao || !this.coverageBuffer || !this.circleTexture) throw Error("Canvas Scene Final Pass 资源分配失败");
	...
	_deleteFrameResources() {
		let e = this.gl;
		e && !this.contextLost && (e.deleteTexture(this.effectTexture), e.deleteTexture(this.bloomTexture), e.deleteTexture(this.coverageTexture), e.deleteFramebuffer(this.coverageFramebuffer)), this.effectTexture = null, this.bloomTexture = null, this.coverageTexture = null, this.coverageFramebuffer = null;
	}
	releaseFrameResources() {
	...
	_createFrameResources(e, t) {
		...
		try {
			this._discardPendingErrors(), hi(n, r, n.NEAREST), n.texImage2D(n.TEXTURE_2D, 0, n.RGBA8, e, t, 0, n.RGBA, n.UNSIGNED_BYTE, null), hi(n, i, n.NEAREST), n.texImage2D(n.TEXTURE_2D, 0, n.R8, e, t, 0, n.RED, n.UNSIGNED_BYTE, null), n.bindFramebuffer(n.FRAMEBUFFER, a), n.framebufferTexture2D(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0, n.TEXTURE_2D, i, 0);
	...
	resize(e, t, n) {
		...
		let r = Math.max(1, e), i = Math.max(1, t), a = di(n, 1, 4), o = Math.max(1, Math.round(r * a)), s = Math.max(1, Math.round(i * a)), c = `${o}:${s}`;
	...
	_createBackgroundTexture(e) {
		...
		try {
			this._discardPendingErrors(), hi(t, n, t.LINEAR), t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL, !1), t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !1), t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL, t.NONE), t.texImage2D(t.TEXTURE_2D, 0, t.SRGB8_ALPHA8, t.RGBA, t.UNSIGNED_BYTE, e);
			let r = t.getError();
	...
	_appendCoverageVertex(e, t, n, r, i) {
		...
		this.coverageVertexData[a] = e, this.coverageVertexData[a + 1] = t, this.coverageVertexData[a + 2] = n, this.coverageVertexData[a + 3] = r, this.coverageVertexData[a + 4] = di(i, 0, 1), this.coverageVertexCount++;
	}
	...
	_uploadEffectCanvas(e, t = this.effectTexture, n = !1) {
		let r = this.gl, i = r.getParameter(r.UNPACK_FLIP_Y_WEBGL), a = r.getParameter(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL), o = r.getParameter(r.UNPACK_COLORSPACE_CONVERSION_WEBGL);
		try {
			return this._discardPendingErrors(), r.bindTexture(r.TEXTURE_2D, t), r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL, !1), r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !0), r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL, r.NONE), n ? r.texImage2D(r.TEXTURE_2D, 0, r.SRGB8_ALPHA8, r.RGBA, r.UNSIGNED_BYTE, e) : r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, r.RGBA, r.UNSIGNED_BYTE, e), r.getError() === r.NO_ERROR;
		} catch {
			return !1;
		} finally {
			r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL, i), r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL, a), r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL, o), r.bindTexture(r.TEXTURE_2D, null);
		}
	}
	_drawCoverage() {
		let e = this.gl;
	...
	render(e, t = null) {
		...
		try {
			if (this._discardPendingErrors(), t) {
				if (!this.bloomTexture) {
					if (this.bloomTexture = this.gl.createTexture(), !this.bloomTexture) return !1;
					hi(this.gl, this.bloomTexture, this.gl.LINEAR);
				}
				if (!this._uploadEffectCanvas(t, this.bloomTexture, !0)) return !1;
			}
			return this._drawCoverage(), this._drawFinal(t !== null), this.gl.flush(), this.gl.getError() === this.gl.NO_ERROR;
		} catch {
			return !1;
		}
	}
	...
	_handleContextLost(e) {
		e?.preventDefault?.(), this.contextLost = !0, this.available = !1, this.finalProgram = null, this.coverageProgram = null, this.fullscreenVao = null, this.coverageVao = null, this.coverageBuffer = null, this.effectTexture = null, this.bloomTexture = null, this.coverageTexture = null, this.coverageFramebuffer = null, this.circleTexture = null, this.backgroundTexture = null, this.failedResizeSignature = null, this.backgroundUploadRetryPending = this.backgroundSource !== null;
	}
	_handleContextRestored() {
...
function yi(e, t, n) {
	let r = e * t / n, i = (r > 0 ? Math.min(Math.PI, 8 / Math.sqrt(r)) : Math.PI) / 32, a = 0;
	for (let e = 0; e <= 32; e++) {
		let t = e === 0 || e === 32 ? 1 : e % 2 == 0 ? 2 : 4;
		a += t * Math.exp(-r * (1 - Math.cos(e * i)));
	}
	return Math.exp(-((e - t) ** 2) / (2 * n)) * a * i / (3 * Math.PI);
}
function bi(e, t, n, r, i) {
	let a = xt(i.intensity), o = e.filter((e) => e.transport > 0);
	if (a <= 0 || o.length === 0) return null;
	let s = Math.max(.1, Math.min(.75, i.resolutionScale)), c = Math.max(1, Math.floor(Math.max(t, n) * r * s)), l = Math.log2(c) + Math.max(0, Math.min(10, i.diffusion)) - 10, u = Math.max(1, Math.min(16, Math.floor(l))), d = .5 + l - Math.floor(l), f = [], p = [], m = 0;
	for (let e of o) {
		let t = e.radius ?? 0, n = e.radius === void 0 ? e.moment / e.transport * .5 : Math.max((e.width ?? 0) ** 2 / 12, t * t * .22);
		for (let i = 0; i < u; i++) {
			let o = 2 ** i / (s * r), c = e.blurScale ?? 1, l = o * o * (1 / 3 + d * d) * c * c * .85, u = Math.max(.25, n + l), h = Math.sqrt(u);
			if (f.push({
				source: e,
				radius: t,
				variance: u,
				weight: a / (2 * Math.PI * u)
			}), m = Math.max(m, t + h * 4), t > 0) for (let e = -3; e <= 3; e++) p.push(Math.max(0, t + e * h));
		}
	}
	let h = [];
	for (let e = 0; e <= 48; e++) p.push(m * (e / 48) ** 2);
	let g = [...new Set(p.map((e) => e / m))].sort((e, t) => e - t);
	for (let e of g) {
		let t = (m * e) ** 2, n = [
			0,
			0,
		...
		if (e < 1) for (let i of f) {
			let a = i.weight * (i.radius > 0 ? yi(m * e, i.radius, i.variance) : Math.exp(-t / (2 * i.variance)));
			for (let e = 0; e < 3; e++) n[e] += i.source.energy[e] * a;
			r += i.source.transport * a;
		}
		h.push({
			position: e,
			energy: n,
...
function Ti(e, t, n, r) {
	...
	let a = n * i * .5;
	if (i >= 1) {
		e.arc(0, 0, a, 0, xi, !1), e.closePath();
		return;
	}
	let o = n * (1 - i), s = t.map((e) => [e[0] * o, e[1] * o]), { normals: c, anticlockwise: l } = wi(s), u = c.at(-1);
...
function Ai(e, t) {
	...
	let n = Di(t);
	if (n <= e[0][0]) return Di(e[0][1]);
	for (let t = 1; t < e.length; t++) {
		let r = e[t - 1], i = e[t];
		if (n <= i[0]) {
			let e = i[0] - r[0], t = e > 0 ? (n - r[0]) / e : 1;
			return Di(Oi(r[1], i[1], ki(t)));
		}
	}
	return Di(e.at(-1)[1]);
}
function ji(e, t) {
	let n = Di(e) * 511, r = Di(t) * 511, i = Math.floor(n), a = Math.floor(r), o = Math.min(511, i + 1), s = Math.min(511, a + 1), c = n - i, l = r - a;
	return Oi(Oi(Gn[a * 512 + i], Gn[a * 512 + o], c), Oi(Gn[s * 512 + i], Gn[s * 512 + o], c), l) / 255;
}
function Mi(e, t = Ei) {
	let n = Math.max(2, Math.floor(t)), r = 1 - Di(e), i = Array(n);
	for (let e = 0; e < n; e++) {
		let t = e / (n - 1);
		i[e] = [t, ji(r, 1 - t)];
	}
...
var W = Math.PI * 2, Ni = [
	...
	255,
	255
], Pi = "baclickfxbackendchange", Fi = "baclickfxeffectbackendchange", Ii = "baclickfxhostcompositingchange", Li = 2 ** 53 - 1, Ri = 4, zi = 1e-6, Bi = 2, Vi = 1e3, Hi = 2, G = Object.freeze({
	negative: "negative",
	positive: "positive"
});
function Ui(e, t) {
...
var ea = 0, K = null, ta = [
	...
	167,
	255
], na = Qi(ta[0] / 255, ta[1] / 255, ta[2] / 255)[0];
function ra(e) {
	if (!/^#[0-9a-f]{6}$/i.test(e)) return 0;
	let [t, n] = Qi(parseInt(e.slice(1, 3), 16) / 255, parseInt(e.slice(3, 5), 16) / 255, parseInt(e.slice(5, 7), 16) / 255);
	return n < .02 ? 0 : t - na;
}
function ia(e) {
	if (ea === 0) return e;
	let [t, n, r] = Qi(e[0] / 255, e[1] / 255, e[2] / 255);
	if (n < .02) return e;
	let i = t + ea;
	i -= Math.floor(i);
	let [a, o, s] = $i(i, n, r);
...
function _a(e, t = 1, n = !1) {
	let r = Math.max(0, t);
	return K && !K.identity ? ct(n ? e : e.map((e) => B(J(e / 255)) * 255), K).map((e) => ga(e) * r) : (K?.identity ? e : ia(e)).map((e) => (n ? ga(e) : J(e / 255)) * r);
}
function Q(e, t, n, r = null) {
	let i = e.map(([e, t]) => [e, aa(t).map(ga)]), a = Math.max(0, n), o = r ? r.map((e) => ga(e * 255)) : [
		1,
		1,
		1
	];
	return ma(i, t).map((e, t) => e * o[t] * a);
}
function va(e, t = 1) {
...
function Sa(e, t, n, r = 1) {
	...
	return oa(.25, .75, o / Math.max(a, 1e-6)) * oa(.03125, .25, o);
}
function Ca(e, t, n = !1) {
	return n ? va(_a(e, 1, !0), t) : ha(e, t);
}
function wa(e, t, n, r = "none", i = 1, a = 1) {
	let o = J(n), s = Math.min(o, J(i));
	if (s <= 1e-5) return "rgba(0, 0, 0, 0)";
	let [c, l, u] = xa(e, t, o, r, a);
	return `rgba(${Math.round(c * 255)}, ${Math.round(l * 255)}, ${Math.round(u * 255)}, ${s})`;
}
function Ta(e, t, n, r, i = "scene", a = t, o = "none", s = 1) {
	let c = J(t) * Math.max(0, n) * r.trailEmissionAlpha, l = xt(r.intensity) / xt(1.7), u = e.map((e) => Math.min(Ct(r.clamp), Math.max(0, e * c))), d = Math.max(...u);
	if (d <= 0) return "rgba(0, 0, 0, 0)";
	let f = jt(d, St(r.threshold), r.softKnee);
	if (f <= 0) return "rgba(0, 0, 0, 0)";
	let p = f / d * l, m = u.map((e) => e * p);
	if (i === "browser-overlay") {
		let e = J(a * l * r.trailEmissionAlpha);
		return wa(m, r.trailAlpha, e, o, s, t);
	}
	return i === "host-additive" ? ba(m, r.trailAlpha, a) : va(m, r.trailAlpha);
}
...
function Oa(e) {
	return e ? typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || Da(e) ? !0 : e?.tagName?.toLowerCase?.() === "canvas" : !1;
}
function ka(e) {
	if (!e) return null;
	let t, n;
...
function ja() {
	...
	return !e || !n ? (Ji = !0, null) : (t.width = 128, t.height = 128, qi = {
		...e,
		canvas: t,
		context: n,
		linearTextureRgba: V,
...
function Ma() {
	...
	if (Xi) return null;
	let e = wn($);
	if (!e) return Xi = !0, null;
	let t = $(), n = $(), r = t.getContext("2d"), i = n.getContext("2d");
	return !r || !i ? (Xi = !0, null) : (t.width = 512, t.height = 512, n.width = 512, n.height = 512, Yi = {
		...e,
		tintCanvas: t,
		tintContext: r,
		outputCanvas: n,
...
function Na(e) {
	...
	for (let n = 0, o = 0, s = 0; n < t.length; n += 4, o++, s += 3) {
		let c = e.linearTextureCoverageFromSrgbRed ? ga(t[n]) : r[o] / 255;
		e.linearTextureCoverageFromSrgbRed && (r[o] = Math.round(J(c) * 255)), i[s] = ga(t[n]), i[s + 1] = ga(t[n + 1]), i[s + 2] = ga(t[n + 2]), a[s] = i[s] * c, a[s + 1] = i[s + 1] * c, a[s + 2] = i[s + 2] * c;
	}
	e.linearTextureCoverage = r, e.linearTextureRgb = i, e.linearTextureEnergyRgb = a;
}
function Pa(e, t, n, r, i, a = 0) {
...
function La() {
	...
	for (let e = 0; e < Fa; e++) Ia[e] = B(e / 4095);
	return Ia;
}
function Ra(e, t) {
	let n = [];
...
function za(e, t, r, i, a, o = 0, s = 0, c = null, l = !1) {
	let u = Math.max(0, Number(i) || 0), d = Math.max(0, Number(a) || 0), f = [
		0,
		1,
		2
	].map((e) => Math.max(0, Number(r[e]) || 0)), p = J(Number(s) || 0), m = J(Number(c?.roundness) || 0), h = c?.coverage ?? null, g = c?.useTextureAlpha === !0, _ = m > 0 && h !== null;
	if (u <= 1e-6 || d <= 1e-6 || Math.max(...f) <= 1e-6 || e.linearTintUnavailable) return null;
	if (!e.linearTintFrames && (e.linearTintFrames = Ra(t, e.linearTintFrameCount), !e.linearTintFrames)) return e.linearTintUnavailable = !0, null;
	Na(e);
	let v = ((Number.isFinite(o) ? Math.trunc(o) : 0) % e.linearTintFrameCount + e.linearTintFrameCount) % e.linearTintFrameCount, y = e.linearTintFrames[v], b = [
		d,
		u,
		...f,
		p,
	...
	if (y.key === b) return y.canvas;
	let { context: x, image: S } = y, C = e.linearTextureEnergyRgb, w = e.linearTextureRgb, T = e.linearTextureCoverage, E = e.linearTextureRgba, D = La(), O = v === 1, k = (e, t, n) => {
		let r = 1;
		if (l) {
			let t = Math.max(...f.map((t, n) => t * C[e + n] * u));
			r = Math.min(1, ga(n * 255) / Math.max(t, 1e-6));
		}
		let i = J(C[e + t] * f[t] * u * r), a = Math.round(i * 4095);
		return D[a] / n;
	};
	x.setTransform(1, 0, 0, 1, 0, 0), x.globalAlpha = 1, x.globalCompositeOperation = "source-over", x.filter = "none", x.imageSmoothingEnabled = !1;
	for (let e = 0; e < t; e++) {
		let r = O ? t - 1 - e : e;
		for (let i = 0; i < t; i++) {
			let a = r * t + i, o = a * 3, s = a * 4, c = (e * t + i) * 4, l = g ? E[s + 3] / 255 : T[a] / 255, v = (i + .5) / t, y = (r + .5) / t;
			_ && ([v, y] = nn(v, y, m));
			let b = _ ? (g ? Pa(E, t, 4, v, y, 3) : Pa(T, t, 1, v, y)) / 255 : l, x = _ ? h[a] / 255 : l, C = Math.round(J(x) * 255);
			if (C === 0) {
				S.data[c] = 0, S.data[c + 1] = 0, S.data[c + 2] = 0, S.data[c + 3] = 0;
				continue;
			}
			let O = C / 255 * d, A = (e) => {
				if (m <= 0) return k(o, e, O);
				let n = 1 + (Pa(w, t, 3, v, y, e) - 1) * J(b), r = J((n + (1 - n) * m) * x * f[e] * u), i = Math.round(r * 4095);
				return D[i] / O;
			}, j = A(0), M = A(1), ee = A(2), N = Math.max(j, M, ee), P = n * p * J(N);
			S.data[c] = Math.round(J(j + (N - j) * P) * 255), S.data[c + 1] = Math.round(J(M + (N - M) * P) * 255), S.data[c + 2] = Math.round(J(ee + (N - ee) * P) * 255), S.data[c + 3] = C;
		}
	}
	return x.putImageData(S, 0, 0), x.globalCompositeOperation = "source-over", x.filter = "none", y.key = b, y.canvas;
}
function Ba(e, t = !1) {
	let n = Ma(), r = Math.max(0, ...e);
...
function Ha(e, t, n = "2147483647", r = "plus-lighter") {
...
function Ka(e, t, n, r, i, a) {
	let o = e, s = t, c = Ua(Ga(o, i), n, a) >= r;
	for (let e = 0; e < 8; e++) {
		let e = (o + s) * .5;
		Ua(Ga(e, i), n, a) >= r === c ? o = e : s = e;
	}
	return (o + s) * .5;
}
function qa(e, t, n, r, i) {
	...
	for (let e = 0; e <= o; e++) {
		let l = e / o, u = Wa(Ga(l, s), r, n, t);
		if (c !== null && c > 0 != u > 0) {
			let u = Ka((e - 1) / o, l, r, n, s, t), d = i(n), f = i(0);
...
function Ja(e, t, n, r, i, a, o) {
	...
	for (let s = 0; s < c; s++) {
		let u = s / c, d = (s + 1) / c, f = Wa(Ga((u + d) * .5, l), a, r, i);
...
function Ya(e, t, n, r, i, a) {
	let o = Math.max(1, Math.round(i.radialSamples)), s = Math.max(0, t - n * .5), c = n / o;
	e.shadowBlur = 0, e.shadowColor = "transparent";
	for (let t = 0; t < o; t++) {
		let n = s + c * t, l = s + c * (t + 1), u = (t + .5) / o, d = qa(e, i, r, u, a);
		if (!d) {
			Ja(e, (n + l) * .5, c, r, i, u, a);
			continue;
		}
		e.beginPath(), e.arc(0, 0, l, 0, W, !1), e.arc(0, 0, n, W, 0, !0), e.closePath(), e.fillStyle = d, e.fill();
	}
}
function Xa(e, t, n, r) {
...
function Za(e, t, n, r, i, a = F, o = !0, s = null, c = "scene", l = !1, u = 1, d = "none", f = 1) {
	let p = a.rings, m = Xa(t, n, r, p);
	if (m.width <= .001) return;
	let h = s ?? Q(p.colorKeys, n, p.hdrIntensity);
	e.save(), e.translate(t.x, t.y), e.rotate(t.rotation), Ya(e, m.radius, m.width, m.threshold, p, (e) => {
		let t = i * e;
		if (c === "browser-overlay") {
			let e = o ? Math.min(1, ga(t * 255) / Math.max(Math.max(...h) * t, 1e-6)) : 1;
			return wa(h, t * e, t, d, f, i);
		}
		return c === "host-additive" ? ba(h, t, t) : va(h, t);
	}), e.restore();
}
function Qa(e, t, n, r, i, a = F, o = null) {
	let s = a.rings, c = a.bloom, l = Xa(t, n, r, s);
	if (l.width <= .001) return;
	let u = o ?? Q(s.colorKeys, n, s.hdrIntensity);
	e.save(), e.translate(t.x, t.y), e.rotate(t.rotation), Ya(e, l.radius, l.width, l.threshold, s, (e) => Ea(u, i * e * c.ringEmissionAlpha, c.emissionRange, c.clickEmissionScale)), e.restore();
}
function $a(e, t, n, r, i, a = F, o = !0, s = 1, c = "scene", l = "none", u = 1) {
	let d = a.disk, f = a.bloom, p = Z(d.sizeKeys, n), m = d.radius * p * r;
	ma(d.colorKeys, n);
	let h = X(d.alphaKeys, n);
	if (m <= 0 || h <= 0) return;
	let g = Q(d.colorKeys, n, f.diskEmission), _ = h * i, v = J(_), y;
	if (c === "browser-overlay") {
		v = Math.min(v, J(u));
		let e = Ma(), t = l === "bright-core" ? Sa(g, i, _, i) : 0;
		e && v > 1e-6 && (y = za(e, 512, g, i, _, 0, t, null, o));
	} else if (c === "host-additive") {
		v = ya(g, i, _)[3];
		let e = Ma();
		e && (y = za(e, 512, g, i, v));
	} else y = Ba(g.map((e) => e / Math.max(h, 1e-5)));
	y && (e.save(), e.globalCompositeOperation = "source-over", e.translate(t.x, t.y), e.rotate(t.diskRotation), e.globalAlpha = v, e.shadowBlur = 0, e.drawImage(y, 0, 0, 512, 512, -m, -m, m * 2, m * 2), e.restore());
}
function eo(e, t, n, r, i, a = F) {
	let o = a.disk, s = a.bloom, c = o.radius * Z(o.sizeKeys, n) * r, l = Ba(Q(o.colorKeys, n, s.diskEmission).map((e) => e * s.clickEmissionScale / s.emissionRange));
...
function so(e, t, n, r) {
	let i = J(n), a = oo(e, i);
	if (!a || (e.roundedSceneFrames || (e.roundedSceneFrames = Ra(128, 2)), !e.roundedSceneFrames)) return null;
	...
	for (let e = 0; e < 128; e++) {
		let t = u ? 127 - e : e;
		for (let n = 0; n < 128; n++) {
			let r = t * 128 + n, o = (e * 128 + n) * 4, l = a[r] / 255, [u, p] = nn((n + .5) / 128, (t + .5) / 128, i), m = Pa(d, 128, 4, u, p, 3) / 255;
			for (let e = 0; e < 3; e++) {
				let t = 1 + (Pa(f, 128, 3, u, p, e) - 1) * J(m), n = t + (1 - t) * i;
...
function co(e, t, n, r, i, a, o = 1, s = "scene", c = "none", l = 1, u = 1, d = 0) {
	let f = ja();
	if (!f) return !1;
	let p = r.map((e) => e * Math.max(0, o)), m = s === "browser-overlay" || s === "host-additive", h = oo(f, d), g = h ? {
		coverage: h,
		roundness: d,
	...
	if (s === "browser-overlay") {
		_ = Math.min(_, J(l));
		let e = c === "bright-core" ? Sa(p, i, i, u) : 0;
		_ > 1e-6 && (v = za(f, 128, p, i, i, a, e, g));
	} else if (s === "host-additive") _ = ya(p, i, i)[3], v = za(f, 128, p, i, _, a, 0, g);
	else {
		let e = f.context, t = p.map((e) => Math.round(J(e) * 255));
		d > 0 && (v = so(f, p, d, a)), v || (e.setTransform(1, 0, 0, 1, 0, 0), e.globalAlpha = 1, e.globalCompositeOperation = "source-over", e.imageSmoothingEnabled = !0, e.clearRect(0, 0, 128, 128), io(e, f.colorCanvas, a), e.globalCompositeOperation = "multiply", e.fillStyle = `rgb(${t[0]}, ${t[1]}, ${t[2]})`, e.fillRect(0, 0, 128, 128), e.globalCompositeOperation = "destination-in", io(e, f.alphaCanvas, a), v = f.canvas);
	}
...
function lo(e, t, n, r, i = F, a = "scene", o = "none", s = 1) {
	let c = i.shards, l = J(t.ageMs / t.lifetimeMs), u = t.size * Z(c.sizeKeys, l) * n, d = X(c.alphaKeys, l) * r, f = Q(c.colorKeys, l, c.hdrIntensity, c.startColor), p = no(t, c), m = ro(t, c), h = ao(c);
	u <= 0 || d <= 0 || co(e, t, u, f, d, p, 1, a, o, s, r, h) || (e.save(), e.translate(t.x, t.y), e.rotate(t.rotation), e.beginPath(), Ti(e, m, u, c.roundness), e.fillStyle = a === "browser-overlay" ? wa(f, d, d, o, s, r) : a === "host-additive" ? ba(f, d, d) : va(f, d), e.shadowColor = "transparent", e.shadowBlur = 0, e.fill(), e.restore());
}
function uo(e, t, n, r, i = F) {
	let a = i.shards, o = J(t.ageMs / t.lifetimeMs), s = t.size * Z(a.sizeKeys, o) * n, c = X(a.alphaKeys, o) * r, l = no(t, a), u = ro(t, a), d = ao(a);
	s <= 0 || c <= 0 || co(e, t, s, [
		1,
		1,
		1
	], c, l, 1, "browser-overlay", "none", 1, r, d) || (e.save(), e.translate(t.x, t.y), e.rotate(t.rotation), e.beginPath(), Ti(e, u, s, a.roundness), e.fillStyle = `rgba(255, 255, 255, ${J(c)})`, e.shadowColor = "transparent", e.shadowBlur = 0, e.fill(), e.restore());
}
function fo(e, t, n, r, i = F) {
	let a = i.shards, o = i.bloom, s = J(t.ageMs / t.lifetimeMs), c = t.size * Z(a.sizeKeys, s) * n, l = X(a.alphaKeys, s) * r, u = Q(a.colorKeys, s, a.hdrIntensity, a.startColor), d = no(t, a), f = ro(t, a), p = ao(a);
	c <= 0 || l <= 0 || co(e, t, c, u, l, d, 1 / Math.max(1, o.emissionRange), "scene", "none", 1, r, p) || (e.save(), e.translate(t.x, t.y), e.rotate(t.rotation), e.beginPath(), Ti(e, f, c, a.roundness), e.fillStyle = Ea(u, l, o.emissionRange), e.fill(), e.restore());
}
function po(e, t, n = F.rings) {
	return Y(pa(n.angularVelocityMinKeys, t), pa(n.angularVelocityMaxKeys, t), e) * n.angularVelocityMultiplier * n.rotationDirection;
}
function mo(e, t, n, r, i, a, o = !1, s = "scene", c = "none", l = 1) {
	let u = a.hit, d = u.radius * r, f = X(u.alphaKeys, n) * i, p = ma(u.colorKeys, n);
	f <= 0 || (e.save(), e.beginPath(), e.arc(t.x, t.y, d, 0, W), e.fillStyle = s === "browser-overlay" ? wa(_a(p, 1, !0), f, f, c, l, i) : s === "host-additive" ? ba(_a(p, 1, !0), f, f) : Ca(p, f, o), e.fill(), e.restore());
}
function ho(e, t, n, r, i, a, o = !1, s = "scene", c = "none", l = 1) {
	let u = a.flare, d = u.radius * r, f = X(u.alphaKeys, n) * i, p = ma(u.colorKeys, n);
	if (!(f <= 0)) {
		e.save(), e.translate(t.x, t.y), e.strokeStyle = s === "browser-overlay" ? wa(_a(p, 1, !0), f, f, c, l, i) : s === "host-additive" ? ba(_a(p, 1, !0), f, f) : Ca(p, f, o);
...
var go = class {
	constructor(e, t, n, r = null) {
		this.fx = n, this.x = e, this.y = t, this.ageMs = 0, this.lastUpdateTimeMs = Number.isFinite(r) ? r : null, this.diskRotation = da(0, W), this.rings = [];
		let i = n.rings;
		for (let n = 0; n < i.count; n++) {
			...
			this.rings.push({
				x: e,
				y: t,
				radius: da(i.radiusMin, i.radiusMax),
				rotation: da(0, W),
				angularBlend: n,
				angularVelocity: po(n, 0, i)
			});
		}
	}
	update(e) {
		...
		for (let r of this.rings) {
			...
			r.angularVelocity = po(r.angularBlend, i, t), r.rotation += r.angularVelocity * (e / 1e3);
		}
	}
	updateTo(e) {
	...
	drawAdditiveBase(e, t, n, r = !1, i = "scene", a = "none", o = 1) {
		...
		this.fx.hit.enabled && s < 1 && mo(e, this, s, t, n, this.fx, r, i, a, o);
		let c = this.ageMs / this.fx.flare.lifetimeMs;
		this.fx.flare.enabled && c < 1 && ho(e, this, c, t, n, this.fx, r, i, a, o);
	}
	drawDiskLayer(e, t, n, r = !0, i = 1, a = "scene", o = "none", s = 1) {
		let c = this.ageMs / this.fx.disk.lifetimeMs;
		c < 1 && $a(e, this, c, t, n, this.fx, r, i, a, o, s);
	}
	...
	drawRings(e, t, n, r = !0, i = 1, a = "scene", o = !1, s = "none", c = 1) {
		...
		if (l < 1) {
			...
			for (let d of this.rings) Za(e, d, l, t, n, this.fx, r, u, a, o, i, s, c);
		}
	}
	...
	drawBloom(e, t, n) {
		...
		if (i < 1) {
			...
			for (let a of this.rings) Qa(e, a, i, t, n, this.fx, r);
		}
	}
	drawBloomCoverage(e, t, n) {
		let r = this.ageMs / this.fx.disk.lifetimeMs;
		r < 1 && to(e, this, r, t, n, this.fx);
		let i = this.ageMs / this.fx.rings.lifetimeMs;
		if (!(i >= 1)) for (let r of this.rings) Za(e, r, i, t, n, this.fx, !1, [
			1,
			1,
			1
		], "browser-overlay");
	...
	appendWebGLSceneAdditiveLayer(e, t, n) {
		...
		if (this.fx.hit.enabled && r < 1) {
			...
			e.addSolidDisk(this.x, this.y, i.radius * t, _a(ma(i.colorKeys, r), 1, !0), a);
		}
		let i = this.ageMs / this.fx.flare.lifetimeMs;
		if (this.fx.flare.enabled && i < 1) {
			let r = this.fx.flare, a = X(r.alphaKeys, i) * n, o = _a(ma(r.colorKeys, i), 1, !0), s = r.radius * t;
	...
	appendWebGLBloom(e, t, n) {
		...
		for (let r of this.rings) {
			let l = Xa(r, i, t, a);
			e.addRing(r.x, r.y, l.radius, l.width, r.rotation, a.radialSamples, a.arcSamples, s, n * o.ringEmissionAlpha * o.clickEmissionScale, (e, t) => Wa(c > 0 ? e : 1 - e, t, l.threshold, a));
		}
	}
	get dead() {
	...
	appendWebGLBloom(e, t, n, r = F) {
		let i = r.shards, a = J(this.ageMs / this.lifetimeMs), o = this.size * Z(i.sizeKeys, a) * t, s = X(i.alphaKeys, a) * n, c = Q(i.colorKeys, a, i.hdrIntensity, i.startColor), l = no(this, i);
		e.addTriangle(this.x, this.y, o, this.rotation, c, s, l, ao(i));
	}
	get dead() {
		return this.ageMs >= this.lifetimeMs;
	}
};
function vo(e, t, n, r, i, a = F.shards, o = null, s = null) {
	let c = r === "click", l = (c ? a.clickRadius : a.trailRadius) * i, u = (c ? da(a.clickSpeedMin, a.clickSpeedMax) : da(a.trailSpeedMin, a.trailSpeedMax)) * i, d = c ? da(a.clickLifetimeMinMs, a.clickLifetimeMaxMs) : da(a.trailLifetimeMinMs, a.trailLifetimeMaxMs);
	return new _o({
		kind: r,
		x: e + Math.cos(n) * l,
		y: t + Math.sin(n) * l,
...
function Co(e, t, n = null, r = n !== null) {
	let i = So(e, r), a = i.distances.map((e) => i.totalLength > 0 ? e / i.totalLength : 0), o = Array(Math.max(0, e.length - 1));
	...
	let s = t.coverageLongitudinalKeys, c = {
		...
		pointProgresses: a,
		segmentProgresses: o,
		pointCoverageFactors: a.map((e) => Ai(s, e)),
		segmentCoverageFactors: o.map((e) => Ai(s, e))
	};
	if (n === null) return c;
	...
	for (let r = 1; r < e.length; r++) {
		let e = o[r - 1], i = wo(e, t, n, g);
		f.push(i), p.push(Math.max(...l[r - 1], ...i, ...l[r])), m.push(Eo(e, t, g)), h.push(Mi(e));
	}
	return {
		...c,
		pointEnergies: l,
...
function wo(e, t, n, r = t.textureLongitudinalKeys) {
	let i = X(r, e);
	return To(e, t, n).map((e) => e * i);
}
function To(e, t, n) {
	return _a(xo(e, t), n);
}
function Eo(e, t, n = t.textureLongitudinalKeys) {
...
function Do(e, t, n = 0, r = 0, i = null) {
	...
	for (let t = 1; t < e.length - 1; t++) {
		...
		if (!Number.isFinite(g) || g > a * Ri || _ < -n.length - 1e-6 || _ > 1e-6 || v < -1e-6 || v > r.length + 1e-6) continue;
...
function Oo(e, t, n, r) {
	...
	return e.meshCache.has(o) || e.meshCache.set(o, Do(t, n, i, a, e.measurement.segmentLengths)), e.meshCache.get(o);
}
function ko(e) {
...
function Ao(e, t, n, r, i) {
	...
	for (let [e, t] of ko(r)) a.addColorStop(J(e), i(t, e));
	return a;
}
function jo(e, t, n, r, i) {
	let a = Ao(e, t.fromLeft, t.fromRight, r, i);
...
function Mo(e, t, n, r) {
	let i = t.points[0], a = Ao(e, i, t.position === "start" ? t.points[1] : t.points[2], n, r);
...
function No(e, t, n, r) {
	return e.pointEnergies?.[t] ? e.pointEnergies[t] : wo(e.measurement.distances[t] / e.measurement.totalLength, n, r);
}
function Po(e, t, n) {
	let r = e.pointTransverseProfiles;
	if (r?.[t]) return r[t];
	let i = Eo(e.measurement.distances[t] / e.measurement.totalLength, n, e.textureLongitudinalKeys);
	return r && (r[t] = i), i;
}
function Fo(e, t, n) {
	...
	return Ai(n.coverageLongitudinalKeys, i);
}
function Io(e, t) {
	let n = e.pointCoverageProfiles;
	if (n?.[t]) return n[t];
	let r = Mi(e.pointProgresses?.[t] ?? e.measurement.distances[t] / e.measurement.totalLength);
	return n && (n[t] = r), r;
}
function Lo(e, t, n, r, i, a, o, s = 1, c = t.length - 1) {
	let l = n.measurement;
	if (l.totalLength <= 0) return;
	e.save(), e.shadowBlur = 0, e.shadowColor = "transparent";
	let u = Oo(n, t, o.scaledWidth ?? o.width * r, a), d = q(Math.floor(s), 1, t.length - 1), f = q(Math.floor(c), d, t.length - 1), p = o.colorAtIntensity ?? ((e, t, n, r) => {
		let a = o.alpha * i * t, s = o.alpha * i * n * r;
		return o.outputCompositing === "browser-overlay" ? wa(e, a, s, o.overlayColorCompensation, o.overlayAlphaLimit, o.globalOpacity ?? i) : o.outputCompositing === "host-additive" ? ba(e, a, s) : va(e, a);
	});
	for (let t = d; t <= f; t++) {
		let r = u.segments[t];
		if (!r) continue;
		let i = (l.distances[t - 1] + l.distances[t]) * .5 / l.totalLength, s = n.segmentEnergies?.[t - 1] ?? wo(i, a, o.materialIntensity), c = n.segmentTransverseProfiles?.[t - 1] ?? Eo(i, a), d = n.segmentCoverageProfiles?.[t - 1] ?? Mi(i), m = n.segmentCoverageFactors?.[t - 1] ?? Ai(a.coverageLongitudinalKeys, i);
		jo(e, r, r.endJoin?.nextSegmentIndex <= f ? r.endJoin : null, c, (e, t) => p(s, e, X(d, t), m));
	}
	for (let t of u.caps) {
		if (t.segmentIndex < d || t.segmentIndex > f) continue;
		let r = No(n, t.pointIndex, a, o.materialIntensity), i = Po(n, t.pointIndex, a), s = Io(n, t.pointIndex), c = Fo(n, t.pointIndex, a);
		Mo(e, t, i, (e, t) => p(r, e, X(s, t), c));
	}
	e.restore();
}
function Ro(e) {
...
function zo(e, t) {
	...
	for (let e = 1; e < n.length; e++) {
		...
		i === null && (i = e - 1), a = e;
		let t = r[e - 1];
		if (!Array.isArray(t) || Ro(t)) return !0;
	}
	if (i === null || !(Math.floor(t.numCapVertices ?? 0) > 0)) return !1;
	let o = e.pointEnergies?.[i], s = e.pointEnergies?.[a];
	return !Array.isArray(o) || !Array.isArray(s) || Ro(o) || Ro(s);
}
function Bo(e, t, n, r, i, a, o, s, c = "scene", l = "none", u = 1) {
	if (n.measurement.totalLength <= 0 || i <= 0 || o.trailAlpha <= 0 || o.trailEmission <= 0 || o.trailEmissionAlpha <= 0 || o.intensity <= 0 || typeof e.filter != "string" || !s?.context || !zo(n, a)) return;
	let d = n.segmentEnergies.findIndex((e) => e.some((e) => e !== 0)), f = n.pointEnergies[0]?.every((e) => e === 0) === !0 && d >= 0 ? d + 1 : 1, p = Math.max(.5, a.geometryWidth * o.trailCoverageScale), m = Math.max(0, a.outerGlowWidth * r * .65), h = p * r * .5, g = Math.ceil(m * 3 + h + 2), _ = Infinity, v = Infinity, y = -Infinity, b = -Infinity, x = f - 1;
	for (let e = x; e < t.length; e++) {
		let n = t[e];
		_ = Math.min(_, n.x), v = Math.min(v, n.y), y = Math.max(y, n.x), b = Math.max(b, n.y);
	}
	let S = Math.floor(_ - g), C = Math.floor(v - g), w = Math.max(1, Math.ceil(y + g) - S), T = Math.max(1, Math.ceil(b + g) - C), E = Math.max(1, s.dpr || 1), D = Math.max(1, Math.ceil(w * E)), O = Math.max(1, Math.ceil(T * E)), k = s.canvas, A = s.context, j = Math.max(k.width, 2 ** Math.ceil(Math.log2(D))), M = Math.max(k.height, 2 ** Math.ceil(Math.log2(O)));
	(k.width !== j || k.height !== M) && (k.width = j, k.height = M), A.setTransform(1, 0, 0, 1, 0, 0), A.clearRect(0, 0, D, O), A.setTransform(E, 0, 0, E, -S * E, -C * E), A.globalCompositeOperation = "lighter", A.filter = "none", Lo(A, t, n, r, i, a, {
		width: p,
		materialIntensity: o.trailEmission,
		colorAtIntensity: (e, t, n, r) => Ta(e, i, t, o, c, i * n * r, l, u)
	}, f), e.save(), e.filter = `blur(${m * E}px)`, e.shadowBlur = 0, e.shadowColor = "transparent", e.drawImage(k, 0, 0, D, O, S, C, w, T), e.restore();
}
function Vo(e, t, n, r, i = F, a = !0, o = null, s = null, c = !1, l = "scene", u = "none", d = 1) {
	let f = i.trail, p = i.bloom, m = r * (f.trailOpacity ?? 1), h = s ?? Co(t, f, p.trailEmission);
	a && Bo(e, t, h, n, m, f, p, o, l, u, d), Lo(e, t, h, n, m, f, {
		width: f.width,
		alpha: 1,
...
function Ho(e, t, n, r, i = F, a = null, o = 1, s = t.length - 1) {
	let c = i.trail, l = r * (c.trailOpacity ?? 1), u = a ?? Co(t, c, 1);
	u.measurement.totalLength <= 0 || l <= 0 || Lo(e, t, u, n, 1, c, {
		width: c.width,
		colorAtIntensity: (e, t, n, r) => `rgba(255, 255, 255, ${J(l * n * r)})`
	}, o, s);
}
function Uo(e, t, n, r, i = F, a = null, o = 1, s = t.length - 1) {
	let c = i.trail, l = i.bloom, u = r * (c.trailOpacity ?? 1) * l.trailEmissionAlpha, d = a ?? Co(t, c, l.trailEmission);
	...
	Lo(e, t, d, n, 1, c, {
		...
		colorAtIntensity: (e, t) => Ea(e, u * t, l.emissionRange)
	}, p, m);
}
function Wo(e, t, n) {
	return {
...
function Go(e, t, n, r, i) {
	let a = Wo(t.fromLeft, n.u, 1), o = Wo(t.fromRight, n.u, 0), s = Wo(t.toLeft, r.u, 1), c = Wo(t.toRight, r.u, 0);
...
function Ko(e, t, n, r) {
	let i = +(t.innerSide === "left"), a = 1 - i, o = Wo(t.inner, n.u, i);
	for (let i = 1; i < t.outerArc.length; i++) {
		let s = Wo(t.outerArc[i - 1], n.u, a), c = Wo(t.outerArc[i], n.u, a);
...
function qo(e, t, n, r, i) {
	for (let a of t.caps) {
		...
		let t = r[a.pointIndex], o = a.position === "start" ? [
			...
			.5,
			0
		], s = a.points.map((e, n) => Wo(e, t.u, o[n]));
...
function Jo(e, t, n, r, i) {
	for (let a = 1; a < t.segments.length; a++) {
		...
		o && n.has(a) && n.has(o.nextSegmentIndex) && Ko(e, o, r[a], i);
	}
}
function Yo(e, t, n, r, i = F, a = null) {
	let o = i.trail, s = i.bloom, c = r * (o.trailOpacity ?? 1), l = a ?? Co(t, o, s.trailEmission), u = o.width * n;
	if (l.measurement.totalLength <= 0 || c <= 0 || u <= 0) return;
	let d = Oo(l, t, u, o), f = /* @__PURE__ */ new Set(), p = Array(t.length);
	for (let e = 0; e < t.length; e++) {
		let t = l.pointProgresses?.[e] ?? l.measurement.distances[e] / l.measurement.totalLength;
		p[e] = {
			u: 1 - t,
			color: To(t, o, s.trailEmission),
			coverage: Fo(l, e, o)
		};
	}
	for (let n = 1; n < t.length; n++) {
		let t = d.segments[n];
		t && (f.add(n), Go(e, t, p[n - 1], p[n], c));
	}
	Jo(e, d, f, p, c), qo(e, d, f, p, c);
}
var Xo = class {
	constructor(e = {}) {
		...
		let a = Da(this.canvas), o = !a || this.config.effectBackend === "canvas2d";
	...
	_syncTouchActionListeners() {
		this.domPointerListenersAttached && (this.usesTouchInputFallback || Zi(this.config.touchAction).requiresShim) ? this._attachTouchActionListeners() : this._detachTouchActionListeners();
	}
	...
	_touchInputsMatch(e, t, n, r, i) {
		...
		return Math.abs(t.clientX - n) <= Hi && Math.abs(t.clientY - r) <= Hi && (a || this._touchTargetsMatch(e, t.target, i));
	}
	...
	_handleTouchStart(e) {
		...
		let t = e.changedTouches, n = Zi(this.config.touchAction), r = (e.touches ?? t)?.[0]?.identifier;
	...
	_syncHostCompositingState() {
		...
		if (this.hostCompositingState = t, !(n || typeof CustomEvent != "function" || typeof this.canvas?.dispatchEvent != "function")) try {
			this.canvas.dispatchEvent(new CustomEvent(Ii, { detail: { ...t } }));
		} catch {}
	}
	...
	_getCanvasRect() {
		return this.host && !Oa(this.host) && typeof this.host.getBoundingClientRect == "function" ? this.host.getBoundingClientRect() : typeof this.canvas?.getBoundingClientRect == "function" ? this.canvas.getBoundingClientRect() : {
			left: 0,
			top: 0,
	...
	_getDomTrailSampleTime(e, t, n) {
		...
		return Math.max(0, n - sa(r, this.config.trailTimeScale));
	}
	...
	_advanceClickTime(e = performance.now()) {
		...
		if (t <= 0) return 0;
		let n = sa(t, this.config.clickTimeScale);
	...
	_advanceTrailTime(e = performance.now()) {
		...
		if (t <= 0) return 0;
		let n = sa(t, this.config.trailTimeScale);
	...
	_appendPointerSample(e, t) {
		...
		let n = this.lastPointerPosition, r = fa(n, e), i = this._getScale(), a = Math.max(.5, this.fxConfig.trail.minVertexDistance * i);
		if (r < a) return;
	...
	_spawnTrailShards(e, t, n, r, i) {
		let a = fa(e, t), o = Math.max(1, this.fxConfig.shards.trailSpacing * n), s = o - this.trailDistanceSinceShard, c = this.currentTrailStroke?.ownerId ?? this.activeTrailOwnerId, l = Number.isFinite(c) ? this.trailShardCounts.get(c) ?? 0 : 0;
		for (; Number.isFinite(c) && s <= a && l < this.fxConfig.shards.maxCount;) {
			let u = a > 0 ? s / a : 0, d = Y(e.x, t.x, u), f = Y(e.y, t.y, u), p = da(0, W);
			this.shards.push(vo(d, f, p, "trail", n, this.fxConfig.shards, Y(r, i, u), c)), l++, this.trailShardCounts.set(c, l), s += o;
		}
	...
	_spawnClick(e, t) {
		...
		this.waves.push(new go(e, t, this.fxConfig, r));
		for (let i = 0; i < this.fxConfig.shards.clickCount; i++) this.shards.push(vo(e, t, da(0, W), "click", n, this.fxConfig.shards, r));
	}
	_requestRender() {
		this.destroyed || this.paused || this.animationFrame !== null || (this.lastFrameTime = this.lastFrameTime ?? performance.now(), this.animationFrame = Wi(this._onFrame));
	}
	_renderFrame(e) {
		...
		try {
			if (!r && this.context && (this.context.save(), g = !0), ea = this._themeHueShift, K = this._relativeOklchTheme, this.context && (this.context.globalCompositeOperation = this._getCanvasOutputCompositing() === "browser-overlay" ? "source-over" : "lighter"), this.renderingFrame = !0, this._updateTrail(this.trailTimeMs, t, s, f, r || o), this._updateWaves(this.clickTimeMs, t, s, f), f && this._drawWaveRings(t, s), this._updateShards(this.clickTimeMs, this.trailTimeMs, t, f), f && s && this._drawNativeClickBloom(t), r) {
				if (this._renderGPUClickEffects(n, t)) this._setWebGLEffectVisible(n === "webgl2"), this._setWebGPUEffectVisible(n === "webgpu"), this._setResolvedEffectBackend(n);
				else {
					let e = n;
			...
			} else c ? (p = this._renderCanvasSceneEffects(t, s), p || (this._setCanvasSceneVisible(!1), this._drawCanvasFallbackFrame(t, s)), this._setCanvasSceneVisible(p), this._setCanvasOutputVisible(!p)) : !o && d && this._drawCanvasFallbackFrame(t, s);
			let e = r || o || p;
			...
			this.renderingFrame = !1, ea = m, K = h, g && this.context.restore();
		}
	...
	_getRequestedEffectBackendState() {
		let e = ve(this.config.effectBackend), t = Da(this.canvas);
	...
	_setResolvedEffectBackend(e) {
		if (this.resolvedEffectBackend !== e && (this.resolvedEffectBackend = e, typeof CustomEvent == "function" && typeof this.canvas?.dispatchEvent == "function")) try {
			this.canvas.dispatchEvent(new CustomEvent(Fi, { detail: {
	...
	_setResolvedBloomBackend(e) {
		if (this.resolvedBloomBackend !== e && (this.resolvedBloomBackend = e, typeof CustomEvent == "function" && typeof this.canvas?.dispatchEvent == "function")) try {
			this.canvas.dispatchEvent(new CustomEvent(Pi, { detail: {
	...
	_ensureWebGPUEffectRenderer() {
		...
		let e = $();
		Ha(e, !this.host && !this.config.isolatedCompositing, "2147483646", ""), e.style.display = "none", this.overlayParent.appendChild(e);
		let t = null;
		try {
			t = new ai(e, {
	...
	_ensureWebGLEffectRenderer() {
		...
		let e = Da(this.canvas);
		if (!this.ownsCanvas && !e || this.ownsCanvas && !this.overlayParent) return !1;
		let t = this.ownsCanvas ? $() : this.canvas;
		this.ownsCanvas && this.overlayParent && (Ha(t, !this.host && !this.config.isolatedCompositing, "2147483646", ""), t.style.display = "none", this.overlayParent.appendChild(t));
		let n = null;
		try {
	...
	_ensureCanvasSceneRenderer() {
		...
		let t = null;
		try {
			if (t = new gi(e), !t.available) return this.canvasSceneUnavailable = !0, t.destroy(), e.remove(), !1;
			let n = this.compositingReferenceSource;
	...
	_releaseBackendFrameResources() {
		this._setWebGPUEffectVisible(!1), this._setWebGLEffectVisible(!1), this._setWebGLBloomVisible(!1), this._setCanvasSceneVisible(!1), this.webgpuEffectRenderer?.releaseFrameResources(), this.webglEffectRenderer?.releaseFrameResources(), this.webglBloomRenderer?.releaseFrameResources(), this.canvasSceneRenderer?.releaseFrameResources(), this._releaseNativeClickBloomSurface(), this._setCanvasOutputVisible(!0);
	}
	_releaseBloomBackendFrameResources() {
		this._setWebGLBloomVisible(!1), this._setCanvasSceneVisible(!1), this.webglBloomRenderer?.releaseFrameResources(), this.canvasSceneRenderer?.releaseFrameResources(), this._releaseNativeClickBloomSurface(), !this.webglEffectVisible && !this.webgpuEffectVisible && this._setCanvasOutputVisible(!0);
	}
	_usesSoftwareBloom() {
		return this._resolveBloomBackend() === "software";
	}
	_releaseNativeClickBloomSurface() {
		this.nativeClickBloomSurface && (this.nativeClickBloomSurface.canvas.width = 0, this.nativeClickBloomSurface.canvas.height = 0, this.nativeClickBloomSurface = null), this.nativeClickBloomMaskSurface && (this.nativeClickBloomMaskSurface.canvas.width = 0, this.nativeClickBloomMaskSurface.canvas.height = 0, this.nativeClickBloomMaskSurface.angularCanvas.width = 0, this.nativeClickBloomMaskSurface.angularCanvas.height = 0, this.nativeClickBloomMaskSurface = null);
	}
	_getBloomRenderer(e) {
	...
	_renderLightBackgroundContrast(e, t = !1) {
		...
		if (n && this.contrastCanvas && (n.setTransform(this.dpr, 0, 0, this.dpr, 0, 0), n.clearRect(0, 0, this.width, this.height), !(this.config.outputCompositing === "browser-overlay" || this.config.lightBackgroundContrastAlpha <= 0))) {
			if (t) n.save(), n.setTransform(1, 0, 0, 1, 0, 0), n.globalCompositeOperation = "source-over", n.drawImage(this.canvas, 0, 0), n.restore();
				...
				for (let t of this.trailStrokes) t.points.length >= 2 && Vo(n, t.points, e, this._getEffectiveOpacity(), this.fxConfig, !1, !1, null, t.trailFrameData);
			...
			n.save(), n.setTransform(1, 0, 0, 1, 0, 0), n.globalCompositeOperation = "source-in", n.fillStyle = ha(Ni, this.config.lightBackgroundContrastAlpha), n.fillRect(0, 0, this.contrastCanvas.width, this.contrastCanvas.height), n.restore();
		}
	}
	_getSoftwareBloomRegions(e) {
		...
		for (let t of this.waves) {
			...
			if (r < 1) for (let n of t.rings) {
				let t = Xa(n, r, e, this.fxConfig.rings);
		...
		for (let e of this.trailStrokes) {
			...
			let n = e.trailFrameData ?? Co(e.points, this.fxConfig.trail, t.trailEmission), r = this._getEffectiveOpacity() * (this.fxConfig.trail.trailOpacity ?? 1) * t.trailEmissionAlpha / Math.max(1, t.emissionRange) * 255, o = [], s = null;
		...
		return r.length === 0 ? [] : [{
			...
			width: this.width,
			height: this.height,
			emissionBounds: ua(r.map((e) => e.emissionBounds)),
	...
	_renderSoftwareBloom(e) {
		let t = this.fxConfig.bloom, n = t.diffusion, r = this._getSoftwareBloomRegions(e), i = ua(r), a = this._captureCanvasOverlayAlpha(e), o = this._prepareCanvasBloomTransportContext(), s = {
		...
		for (let i = 0; i < r.length; i++) {
			...
			for (let t of a.trailBatches) {
				let n = t.stroke;
				n.points.length >= 2 && Uo(d, n.points, e, this._getEffectiveOpacity(), this.fxConfig, n.trailFrameData, t.firstSegment, t.lastSegment);
			}
			...
			if (d.restore(), f) {
				...
				for (let t of a.trailBatches) {
					let n = t.stroke;
					n.points.length >= 2 && Ho(f, n.points, e, this._getEffectiveOpacity(), this.fxConfig, n.trailFrameData, t.firstSegment, t.lastSegment);
				}
	...
	_renderWebGL2Scene(e, t) {
		...
		try {
			e.beginFrame();
			for (let n of this.trailStrokes) n.points.length < 2 || Yo(e, n.points, t, this._getEffectiveOpacity(), this.fxConfig, n.trailFrameData);
	...
	_renderCanvasSceneEffects(e, t) {
		...
		try {
			...
			this._drawWaveRings(e, t, !0, "scene", "coverage", 1);
			...
			if (t) {
				...
				let { canvas: t, context: n } = this.nativeClickBloomSurface, r = Math.max(1, Math.ceil(this.canvas.width * .5)), i = Math.max(1, Math.ceil(this.canvas.height * .5));
				(t.width !== r || t.height !== i) && (t.width = r, t.height = i), n.setTransform(1, 0, 0, 1, 0, 0), n.clearRect(0, 0, r, i), n.setTransform(r / this.width, 0, 0, i / this.height, 0, 0), this._drawNativeClickBloom(e, n, "host-additive");
			}
			return n.render(this.canvas, t ? this.nativeClickBloomSurface.canvas : null);
		} catch (e) {
	...
	_restoreCanvasOutputAfterContextLoss(e) {
		let t = this._getScale(), n = ea, r = K, i = e;
		this._setResolvedBloomBackend(i), this.resolvedBloomBackend === "native" && (i = "native");
		let a = !1;
		try {
			this.context.save(), a = !0, ea = this._themeHueShift, K = this._relativeOklchTheme, this._drawCanvasFallbackFrame(t, i === "native"), this._renderLightBackgroundContrast(t, i === "software"), i === "software" && this._hasVisibleEffects() && (this._renderSoftwareBloom(t), this.bloomRenderer.available || (i = "native"));
		} catch (e) {
			...
			ea = n, K = r, a && this.context.restore();
		}
	...
	_drawNativeClickBloom(e, t = this.context, n = this._getCanvasOutputCompositing()) {
		...
		let a = r.clickEmissionScale;
		t.save(), t.globalCompositeOperation = "lighter", t.globalAlpha = i, t.shadowBlur = 0;
		for (let o of this.waves) {
			let s = [], c = this.fxConfig.disk, l = o.ageMs / c.lifetimeMs;
			if (l < 1 && r.diskAlpha > 0 && r.diskBlur > 0) {
				let t = c.radius * Z(c.sizeKeys, l) * e, n = Q(c.colorKeys, l, r.diskEmission * a * r.diskEmissionAlpha), i = _i(r);
				i.blurScale = r.diskBlur / 65;
			...
			if (!m) continue;
			let h = t, g = h === t ? 1 : null.gain, _ = h.createRadialGradient(f, p, 0, f, p, m.radius);
			for (let e of m.stops) {
				let t = n === "scene" ? va(e.energy, g) : n === "browser-overlay" ? wa(e.energy, g, B(e.transport * g), "none", this._getEffectiveOverlayAlphaLimit(), i) : ba(e.energy, g, B(e.transport * g));
				_.addColorStop(e.position, t);
			}
			if (h.fillStyle = _, h.fillRect(f - m.radius, p - m.radius, m.radius * 2, m.radius * 2), h !== t) {
				let { angularCanvas: e, angularContext: n } = this.nativeClickBloomMaskSurface;
				(e.width !== h.canvas.width || e.height !== h.canvas.height) && (e.width = h.canvas.width, e.height = h.canvas.height), n.setTransform(1, 0, 0, 1, 0, 0), n.clearRect(0, 0, 0, 0);
				let r = n.createConicGradient(0, 0, 0);
				for (let e = 0; e <= null.values.length; e++) r.addColorStop(e / null.values.length, `rgba(255, 255, 255, ${null.values[e % null.values.length]})`);
				n.globalCompositeOperation = "source-over", n.fillStyle = r, n.fillRect(0, 0, 0, 0);
				let i = null.radius / m.radius * 0, a = Math.max(4, i * .35), o = n.createRadialGradient(0, 0, Math.max(0, i - a), 0, 0, i + a);
				o.addColorStop(0, "rgba(255, 255, 255, 0)"), o.addColorStop(.18, "rgba(255, 255, 255, 1)"), o.addColorStop(.82, "rgba(255, 255, 255, 1)"), o.addColorStop(1, "rgba(255, 255, 255, 0)"), n.globalCompositeOperation = "destination-in", n.fillStyle = o, n.fillRect(0, 0, 0, 0);
				let s = Math.max(1, null.radius / m.radius * 0 * .85);
				for (let e of [!1, !0]) {
					let t = n.createRadialGradient(0, 0, 0, 0, 0, s), r = e ? 1 / null.gain : 1;
					t.addColorStop(0, `rgba(255, 255, 255, ${r})`), t.addColorStop(1, "rgba(255, 255, 255, 0)"), n.globalCompositeOperation = e ? "lighter" : "destination-out", n.fillStyle = t, n.fillRect(0, 0, 0, 0);
				}
				let c = Math.min(0, Math.max(s, null.radius / m.radius * 0 * 1.15)), l = n.createRadialGradient(0, 0, c, 0, 0, 0), u = n.createRadialGradient(0, 0, c, 0, 0, 0);
				u.addColorStop(0, "rgba(255, 255, 255, 0)"), u.addColorStop(1, "rgba(255, 255, 255, 1)"), n.globalCompositeOperation = "destination-out", n.fillStyle = u, n.fillRect(0, 0, 0, 0), l.addColorStop(0, "rgba(255, 255, 255, 0)"), l.addColorStop(1, `rgba(255, 255, 255, ${1 / null.gain})`), n.globalCompositeOperation = "lighter", n.fillStyle = l, n.fillRect(0, 0, 0, 0), h.setTransform(1, 0, 0, 1, 0, 0), h.globalCompositeOperation = "destination-in", h.drawImage(e, 0, 0), t.drawImage(h.canvas, 0, 0, 0, 0, f - m.radius, p - m.radius, m.radius * 2, m.radius * 2);
			}
		}
		t.restore();
	}
	_drawCanvasTrails(e, t, n = !1) {
		...
		for (let o = this.trailStrokes.length - 1; o >= 0; o--) {
			...
			s.points.length < 2 || (Array.isArray(s.trailFrameData?.segmentEnergies) || (s.trailFrameData = Co(s.points, this.fxConfig.trail, this.fxConfig.bloom.trailEmission)), Vo(this.context, s.points, e, this._getEffectiveOpacity(), this.fxConfig, t, r, s.trailFrameData, n, i, "none", a));
		}
	}
	...
	setPaused(e, t = {}) {
		...
		if (e === !0) {
			if (!this.paused) {
				...
				this._advanceClickTime(e), this._advanceTrailTime(e), this.paused = !0, this.touchGestureStarts.clear(), this.touchPointerFilterResults.length = 0, this.closedShadowPointerDecisions = /* @__PURE__ */ new WeakMap(), this.activePointerId !== null && this._releaseActivePointer(), this.animationFrame !== null && (Gi(this.animationFrame), this.animationFrame = null), this.lastFrameTime = null, this.lastClickTimeSource = null, this.lastTrailTimeSource = null;
			}
	...
	setCompositingReference(e, t = {}) {
		...
		let n = t.fit ?? "cover";
		if (n !== "cover" || e !== null && !ka(e)) return !1;
		...
		return this._applyCompositingReferenceToRenderers(e, n, r, i, a) ? (this.compositingReferenceSource = e, this.compositingReferenceFit = n, this.lastSoftwareBloomFrame = null, this._requestCompositingMountRefresh(), e !== null && (this.webgpuEffectUnavailable = !1, this.webglEffectUnavailable = !1, this.webglBloomUnavailable = !1, this.canvasSceneUnavailable = !1), a && (this._invalidateSceneBackgroundOutputs(), this._flushCompositingMountRefresh()), e === null && (this.canvasSceneRenderer?.releaseFrameResources(), this._releaseNativeClickBloomSurface()), this._requestRender(), !0) : !1;
	}
	getConfig() {
	...
	destroy() {
		if (!this.destroyed) {
			this.destroyed = !0, typeof window < "u" && window.removeEventListener("resize", this._onResize), this._detachDomPointerListeners(), typeof window < "u" && window.removeEventListener("blur", this._onBlur), this.resizeObserver?.disconnect(), this.animationFrame !== null && (Gi(this.animationFrame), this.animationFrame = null), this.clear();
...
//#endregion
export { Xo as BAClickFX, Xo as default, Pi as BLOOM_BACKEND_CHANGE_EVENT, ge as CONFIG, re as DEFAULT_THEME_COLOR, ie as DEFAULT_THEME_COLOR_MODE, Fi as EFFECT_BACKEND_CHANGE_EVENT, he as FX_PARAM_MIGRATIONS, me as FX_PARAM_SCHEMA, se as FX_PARAM_SCHEMA_VERSION, Ii as HOST_COMPOSITING_CHANGE_EVENT, oe as SIZE_CORRECTION, F as UNITY_FX_TOUCH, Zo as applyFxParamPatch, He as createConfig };
